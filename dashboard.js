...
exports.dashboard = exports.PerformanceDashboard = void 0;
const performance_tracker_1 = require("./performance-tracker");
class PerformanceDashboard {
    constructor() {
        this.data = performance_tracker_1.performanceTracker.getData();
    }
    ...
    showOverallStats() {
        ...
        if (stats.totalProblems > 0) {
            console.log(`⏱️ Average Time: ${(0, performance_tracker_1.formatDuration)(stats.averageTime)}`);
            console.log(`🏃 Best Time: ${(0, performance_tracker_1.formatDuration)(stats.bestTime)}`);
            console.log(`🐌 Worst Time: ${(0, performance_tracker_1.formatDuration)(stats.worstTime)}`);
            // Improvement trend
    ...
    showDayBreakdown() {
        ...
        this.data.dayStats.forEach(day => {
            ...
            console.log(`   Average Time: ${(0, performance_tracker_1.formatDuration)(day.averageTime)}`);
            console.log(`   Total Time: ${(0, performance_tracker_1.formatDuration)(day.totalTime)}`);
    ...
    showRecentActivity(count = 5) {
        ...
        recent.forEach((result, index) => {
            ...
            console.log(`   Time: ${(0, performance_tracker_1.formatDuration)(result.duration)} | ${timeAgo}`);
    ...
    showGoalsProgress() {
        ...
        if (stats.totalProblems > 0) {
            ...
            console.log(`${timeStatus} Average Time Goal: ${(0, performance_tracker_1.formatDuration)(stats.averageTime)} / ${(0, performance_tracker_1.formatDuration)(goals.targetTimePerProblem)}`);
        }
        else {
            console.log(`⏱️ Average Time Goal: - / ${(0, performance_tracker_1.formatDuration)(goals.targetTimePerProblem)}`);
        }
        // Success rate goal
        if (stats.totalProblems > 0) {
...
exports.dashboard = new PerformanceDashboard();
